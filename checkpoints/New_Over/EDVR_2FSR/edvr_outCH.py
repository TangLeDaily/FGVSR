...
class TSAFusion(nn.Module):
    ...
    def forward(self, aligned_feat):
        ...
        return feat, out_start, after_dot
...
class EDVR(nn.Module):
    ...
    def forward(self, x):
        ...
        feat, out_start, after_dot = self.fusion(aligned_feat)
        after_attn = feat
        ...
        # out_start = self.conv_last(self.lrelu(self.conv_hr(out_start)))
        return out, out_start, after_dot, after_attn