...
from util import *
from rootmodel.EDVR_SP_L2 import *

use_wandb = False
Project_name = "SPVSR_SUP"
This_name = "EDVR_pre_SP_L2FSR_add"

parser = argparse.ArgumentParser(description="PyTorch Data_Pre")
parser.add_argument("--train_root_path", default='datasets/train_addD/', type=str, help="train root path")
...
def main():
    ...
    state_dict = torch.load("/home/tangle/code/FGVSR/checkpoints/state/epoch_249_psnr_29.7878_lr_1.511157274518289e-06.pth", map_location='cpu')
