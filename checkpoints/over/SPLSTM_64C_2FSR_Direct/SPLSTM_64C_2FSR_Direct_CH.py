...
class TSAFusion(nn.Module):
    ...
    def forward(self, aligned_feat, pre_h, pre_c):
        ...
        return feat, next_h, next_c, start
...
class EFVSR(nn.Module):
    ...
    def forward(self, x, last_h, last_c):
        ...
        if last_h is None:
            feat, next_h, next_c, out_start = self.fusion(aligned_feat, None, None)
        else:
            feat, next_h, next_c, out_start = self.fusion(aligned_feat, last_h, last_c)
        ...
        return out, next_h, next_c, out_h, out_c, out_start
